...
int main(void)
{
  ...
  nyzj.kar = '[';
  nyzj.ism = 2;
  nyzj.sor = 2; /* Objektumok tagjainak a kezdőértékei */
  es.kar = '&';
  es.ism = 3;
  es.sor = 3; /* Objektumok tagjainak a kezdőértékei */
  zzj.kar = ']';
  zzj.ism = 4;
  zzj.sor = 1; /* Objektumok tagjainak a kezdőértékei */
  cout << "\n"
       << endl;
...
private:
  ...
  int sor;  /* sorok száma, amennyiben megjelenjen */
public:
  void kezdo(char kr, int im, int sr)
  {
    kar = kr;
    ism = im;
    sor = sr;
