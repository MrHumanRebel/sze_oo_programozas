...
void in_ch::b_ki()
 {
  sps = {{1, {"Ú: ", {tagok.getSwim()/oRA, {(tagok.getSwim()%oRA)/pRC, (tagok.getSwim()%oRA)%pRC}}}},\
         {2, {"B: ", {tagok.getCycle()/oRA, {(tagok.getCycle()%oRA)/pRC, (tagok.getCycle()%oRA)%pRC}}}},\
         {3, {"D: ", {tagok.getDepo()/oRA, {(tagok.getDepo()%oRA)/pRC, (tagok.getDepo()%oRA)%pRC}}}},\
         {4, {"Ú+B+D: ", {(tagok.getSwim()+tagok.getCycle()+tagok.getDepo())/oRA,\
                         {((tagok.getSwim()+tagok.getCycle()+tagok.getDepo())%oRA)/pRC,\
                          ((tagok.getSwim()+tagok.getCycle()+tagok.getDepo())%oRA)%pRC}}}},\
         {5, {"F: ", {tagok.getRun()/oRA, {(tagok.getRun()%oRA)/pRC, (tagok.getRun()%oRA)%pRC}}}},\
